...
class ProfileTests(TestCase):
    def setUp(self):
        self.not_shared_profiles = [
            {'taxa1': 0.20, 'taxa2': 0.30, 'taxa3': 0.15, 'taxa4': 0.35,
             'not_shared': 0.00},
            {'taxa1': 0.10, 'taxa2': 0.50, 'taxa3': 0.15, 'taxa4': 0.25}]
        self.uneven_profiles = [
            {'taxa1': 0.20, 'taxa3': 0.30, 'taxa5': 0.15, 'taxa6': 0.35},
            {'taxa1': 0.10, 'taxa2': 0.50, 'taxa4': 0.15, 'taxa5': 0.05,
             'taxa7': 0.20}]
        self.many_profiles = [
            {'taxa1': 0.20, 'taxa2': 0.30, 'taxa3': 0.15, 'taxa4': 0.35},
            {'taxa1': 0.10, 'taxa2': 0.50, 'taxa3': 0.15, 'taxa4': 0.25},
    ...
    def test_compare_profiles_fail(self):
        '''Make sure error raised when given an empty list or a single\
         profile'''
        #empty list check
